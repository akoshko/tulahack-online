...
using Tulahack.UI.Validation.Validators;
using Tulahack.UI.Validation.Validators.Compare;
...
public static class CommonValidatorsExtensions
{
    ...
    public static TNext NotNull<TObject, TProp, TNext>(
        ...
        where TNext : IRuleBuilder<TObject, TProp, TNext>
        where TObject : IValidatableObject =>
        ruleBuilder.SetValidator(new NotNullValidator<TObject, TProp>(validationMessageType));
    ...
    public static TNext Null<TObject, TProp, TNext>(
        ...
        where TNext : IRuleBuilder<TObject, TProp, TNext>
        where TObject : IValidatableObject =>
        ruleBuilder.SetValidator(new NullValidator<TObject, TProp>(validationMessageType));
    ...
    public static TNext Must<TObject, TProp, TNext>(
        ...
        where TNext : IRuleBuilder<TObject, TProp, TNext>
        where TObject : IValidatableObject =>
        ruleBuilder.SetValidator(new PredicateValidator<TObject, TProp>(predicate, validationMessageType));
    ...
    public static TNext Must<TObject, TProp, TNext>(
        ...
        where TNext : IRuleBuilder<TObject, TProp, TNext>
        where TObject : IValidatableObject =>
        ruleBuilder.SetValidator(new AsyncPredicateValidator<TObject, TProp>(predicate, validationMessageType));
}
