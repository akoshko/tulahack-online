...
using Tulahack.UI.Validation.Validators.Collections;
...
public static class CollectionValidatorsExtensions
{
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        ruleBuilder.SetValidator(new CountValidator<TObject, TCollection, TItem>(_ => minCount, _ => maxCount, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new CountValidator<TObject, TCollection, TItem>(_ => minCount, maxCountExpression, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new CountValidator<TObject, TCollection, TItem>(minCountExpression, _ => maxCount, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new CountValidator<TObject, TCollection, TItem>(minCountExpression, maxCountExpression, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> MinCount<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new MinCountValidator<TObject, TCollection, TItem>(_ => minCount, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> MinCount<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new MinCountValidator<TObject, TCollection, TItem>(minCountExpression, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> MaxCount<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new MaxCountValidator<TObject, TCollection, TItem>(_ => maxCount, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> MaxCount<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new MaxCountValidator<TObject, TCollection, TItem>(maxCountExpression, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new ExactCountValidator<TObject, TCollection, TItem>(_ => count, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> Count<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new ExactCountValidator<TObject, TCollection, TItem>(countExpression, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> EachElement<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new EachElementValidator<TObject, TCollection, TItem>(validCondition, validationMessageType));
    ...
    public static ICollectionRuleBuilderInitial<TObject, TCollection, TItem> NotEmpty<TObject, TCollection, TItem>(
        ...
        where TObject : IValidatableObject
        where TCollection : IEnumerable<TItem> =>
        ruleBuilder.SetValidator(new NotEmptyCollectionValidator<TObject, TCollection, TItem>(validationMessageType));
}