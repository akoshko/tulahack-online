    ...
    where TObject : IValidatableObject
{
    ...
    public ValidationContextFactory<TObject> CreateContextFactory(string propertyName) =>
        new(_validatableObject, _validationContextCache, _propertyChangedStopwatches, propertyName, _displayNamesSources[propertyName], GetPropertyValue(propertyName));
